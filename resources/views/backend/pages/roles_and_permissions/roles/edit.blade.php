...
<form id="edit-save-role" method="POST" class="form" action="{{route('edit-save-role')}}">
    @csrf
    <!--begin::Input group-->
                            ...
                            <td>
                                <div class="d-flax">
                                    ...
                                    <label class="form-check form-check-sm form-check-custom form-check-solid me-2 ">
                                        <input class="form-check-input permission-{{$firstWord}}" type="checkbox" value="{{$permission->name}}" {{$assign_permissions->contains($permission->name) ? 'checked' : '' }}  name="permission[]">
