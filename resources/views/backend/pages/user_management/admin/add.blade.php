    ...
    <div class="col-xl-12 mb-xl-10">
        <div class="card mb-5 mb-xl-10">
            <div id="kt_account_add_backend_user" class="collapse show">
                <form id="add_admin_user_form" class="form fv-plugins-bootstrap5 fv-plugins-framework" method="POST" action="{{route('add-save-admin')}}">
                    @csrf
                    <div class="card-body p-9">
                        ...
                        <div class="row g-5 g-xl-8 mb-5">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control form-control-solid form-control-lg" autocomplete="off" name="name" id="name" placeholder="Please enter full name" value=""/>
                            </div>

                            <div class="col-md-6">
                                <label class="form-label required">Email</label>
                                <input type="text" class="form-control form-control-solid form-control-lg " autocomplete="off" name="email" id="email" placeholder="Please enter email" value="{{ old('email') }}" autocomplete="off" />
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="role" id="role" class="form-select form-select-solid form-select-lg " data-control="select2" data-placeholder="Select Role" data-allow-clear="true">
                                    @foreach($roles as $value)
                                        <option value="{{ $value->name }}" @if(old('role') == $value->name) selected @endif>
                                            {{ ucfirst($value->name) }}
                                        </option>
                                    @endforeach
                                </select>
