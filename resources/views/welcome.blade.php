                            ...
                            <div class="menu menu-rounded menu-column menu-lg-row my-5 my-lg-0 align-items-stretch fw-semibold px-2 px-lg-0"
                                ...
                                <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}"
                                    ...
                                    <span class="menu-link">
                                        <span class="menu-title"> {{ Config::get('constants.SYSTEM_NAME') }}</span>
                        ...
                        <div class="app-navbar flex-shrink-0">
                            ...
                            <div class="app-navbar-item ms-1 ms-md-4" id="kt_header_user_menu_toggle">
                                ...
                                <div class="cursor-pointer symbol symbol-35px"
                                    ...
                                    <img src="{{ asset('backend/media/avatars/300-3.jpg') }}" class="rounded-3"
                                        alt="user" />
                                </div>
                                    ...
                                    <div class="menu-item px-3">
                                        <div class="menu-content d-flex align-items-center px-3">
                                            ...
                                            <div class="symbol symbol-50px me-5">
                                                <img alt="Logo"
                                                    src="{{ asset('backend/media/avatars/300-3.jpg') }}" />
                                            </div>
                                            <!--end::Avatar-->
                                            <!--begin::Username-->
                    ...
                    <div id="kt_app_footer" class="app-footer" style="background: whitesmoke;">
                        ...
                        <div
                            ...
                            <div class="text-gray-900 order-2 order-md-1">
                                ...
                                <a href="javascript:;"
                                    class="text-gray-800 text-hover-primary">{{ Config::get('constants.SYSTEM_NAME') }}</a>
                            </div>
                            <!--end::Copyright-->
