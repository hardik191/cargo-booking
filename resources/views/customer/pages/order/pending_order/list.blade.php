...
@section('content')
    ...
    <div class="card card-flush">
        ...
        <div class="card-body pt-0 classTable">
            <table class="table align-middle table-row-dashed1 fs-6 gy-3 mb-0" id="pending_order_list">
                <thead>
...
<div class="modal fade" tabindex="-1" id="orderPaymentModal">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title">Paymnet Alert</h3>
                <!--begin::Close-->
            ...
            <div class="modal-body">
                <p class="h6">Are you sure you want to Paymnet Alert ?</p>
            </div>
