						...
						<div class="w-lg-500px p-10">
							<form class="form w-100" id="sign-up-form" action="{{ route('save-create-customer-account') }}" method="post">
                                ...
                                <div class="fv-row mb-8">
									<input type="text" placeholder="Name" name="name" autocomplete="off" class="form-control bg-transparent name" />
								</div>
								<div class="fv-row mb-8">
                                ...
                                <div class="fv-row mb-8 fv-plugins-icon-container" >
									<div class="mb-1" data-kt-password-meter="true">
                                        <div class="input-group position-relative">
                                            <input class="form-control input-group-required form-control-lg valid" type="password" placeholder="Password" name="password" id="password" autocomplete="off" data-kt-translate="sign-up-input-password" aria-invalid="false">
